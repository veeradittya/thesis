...
export function PortfolioMarketsCard({
  ...
  return (
    ...
    >
      {/* header — drag handle */}
      <div {...dragHandle} className="shrink-0 cursor-move touch-none select-none border-b border-white/[0.06] px-5 pt-4 pb-2.5">
        <p className="text-[10px] uppercase tracking-wider text-[#8a8a8a]">Prediction Markets</p>
        <h2 className="mt-1 text-[16px] font-semibold text-white">Across your holdings</h2>
      </div>
